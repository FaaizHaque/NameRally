...
import { WORLD_PLACES_SET } from './world-places';
import {
  WORLD_NAMES_SET,
  ANIMALS_SET,
  THINGS_SET,
  SPORTS_GAMES_SET,
  FRUITS_VEGETABLES_SET,
  BRANDS_SET,
  HEALTH_ISSUES_SET,
} from '../data/extended-database';
import {
...
export const WORD_DATABASE: Record<CategoryType, Record<string, string[]>> = {
  ...
  songs: {
    A: ['All of Me', 'American Pie', 'Ain\'t No Sunshine', 'Africa', 'Angel', 'Apologize', 'As It Was', 'Attention', 'All Star', 'Another One Bites the Dust'],
    B: ['Bohemian Rhapsody', 'Believer', 'Bad Guy', 'Billie Jean', 'Blinding Lights', 'Boulevard of Broken Dreams', 'Born This Way', 'Beat It', 'Black', 'Bad Romance'],
    C: ['Crazy', 'Circles', 'Creep', 'California Dreamin', 'Closer', 'Can\'t Help Falling in Love', 'Complicated', 'Counting Stars', 'Clocks', 'Chandelier'],
    D: ['Dancing Queen', 'Despacito', 'Don\'t Stop Believin', 'Dreams', 'Drivers License', 'Dynamite', 'Dance Monkey', 'Demons', 'Drops of Jupiter'],
    E: ['Easy', 'Every Breath You Take', 'Empire State of Mind', 'Enter Sandman', 'Electric Feel', 'Everybody Wants to Rule the World'],
    F: ['Firework', 'Fix You', 'Fly Me to the Moon', 'Fortunate Son', 'Free Fallin', 'Feeling Good', 'Faith', 'Flowers', 'Feel Good Inc'],
    G: ['Gangsta\'s Paradise', 'Girls Just Want to Have Fun', 'God\'s Plan', 'Gold Digger', 'Good Vibrations', 'Goosebumps', 'Glad You Came'],
    H: ['Happy', 'Hello', 'Hotel California', 'Hallelujah', 'Hey Jude', 'Hips Don\'t Lie', 'Hotline Bling', 'Here Comes the Sun', 'Humble', 'Heart of Glass'],
    I: ['Imagine', 'I Will Always Love You', 'In the End', 'I Gotta Feeling', 'Iris', 'I Will Survive', 'It\'s My Life'],
    J: ['Just Dance', 'Just the Way You Are', 'Just You and Me', 'Jealous', 'Jump', 'Jailhouse Rock', 'Johnny B. Goode'],
    K: ['Karma Chameleon', 'Killing Me Softly', 'Kiss', 'Kids', 'Knocking on Heaven\'s Door'],
    L: ['Levitating', 'Livin\' on a Prayer', 'Love Story', 'Lean on Me', 'Let It Be', 'Locked Out of Heaven', 'Lose Yourself', 'Lucky', 'Lemon'],
    M: ['Mr. Brightside', 'My Heart Will Go On', 'Music', 'Monster', 'Money', 'Memories', 'Mad World', 'Man in the Mirror'],
    N: ['No Woman No Cry', 'Never Gonna Give You Up', 'Night Fever', 'New Rules', 'Nothing Compares'],
    O: ['Old Town Road', 'One', 'Ordinary People', 'Oops I Did It Again'],
    P: ['Purple Rain', 'Perfect', 'Piano Man', 'Paradise', 'Poker Face', 'Photograph', 'Party Rock Anthem', 'Pumped Up Kicks'],
    Q: ['Queen', 'Que Sera Sera'],
    R: ['Royals', 'Respect', 'Rolling in the Deep', 'Rocket Man', 'Riptide', 'Radioactive', 'Roar', 'Ring of Fire'],
    S: ['Shape of You', 'Smells Like Teen Spirit', 'Stairway to Heaven', 'Superstition', 'Sweet Child O Mine', 'Shallow', 'Stay', 'Someone Like You', 'Sorry', 'Smooth'],
    T: ['Thriller', 'Take On Me', 'Toxic', 'The Scientist', 'Tik Tok', 'Timber', 'Thunder', 'Time After Time', 'True Colors', 'Torn'],
    U: ['Umbrella', 'Under Pressure', 'Uptown Funk', 'Unchained Melody', 'Use Somebody'],
    V: ['Viva La Vida', 'Valerie', 'Video Games', 'Vogue'],
    W: ['Wonderwall', 'We Will Rock You', 'Wake Me Up', 'Wrecking Ball', 'What\'s Going On', 'Watermelon Sugar', 'Wild Thing', 'Wish You Were Here'],
    X: ['XO'],
    Y: ['YMCA', 'Yesterday', 'You Belong With Me', 'Yellow', 'You\'re Beautiful'],
    Z: ['Zombie', 'Zoot Suit Riot'],
  },
  professions: {
...
export const validateWithFallback = async (
  ...
  if (!trimmed || trimmed.length < 2 || !trimmed.startsWith(letterLower)) {

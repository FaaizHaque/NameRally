...
const CATEGORY_PASTEL: Record<string, { bg: string; border: string; selectedBg: string; ink: string }> = {
  names:              { bg: '#FEF3A3', border: '#E8D840', selectedBg: '#F8E040', ink: '#8B7A10' },
  places:             { bg: '#C8F5D0', border: '#50B870', selectedBg: '#50B870', ink: '#2A6640' },
  animal:             { bg: '#FFD4D4', border: '#E07070', selectedBg: '#E07070', ink: '#882020' },
  thing:              { bg: '#D0EAFF', border: '#60A8E0', selectedBg: '#60A8E0', ink: '#205880' },
  sports_games:       { bg: '#C8DFFF', border: '#5080D8', selectedBg: '#5080D8', ink: '#204080' },
  brands:             { bg: '#F0D8FF', border: '#B878D8', selectedBg: '#B878D8', ink: '#602880' },
  health_issues:      { bg: '#FFE0CC', border: '#E07040', selectedBg: '#E07040', ink: '#882010' },
  countries:          { bg: '#C8DFFF', border: '#4878D0', selectedBg: '#4878D0', ink: '#183070' },
  movies:             { bg: '#E0CCFF', border: '#9060D8', selectedBg: '#9060D8', ink: '#402880' },
  songs:              { bg: '#FFD0E8', border: '#D858A0', selectedBg: '#D858A0', ink: '#882060' },
  professions:        { bg: '#F5E0A0', border: '#C8A030', selectedBg: '#C8A030', ink: '#705010' },
  food_dishes:        { bg: '#FFD8C8', border: '#E06040', selectedBg: '#E06040', ink: '#882010' },
  famous_people:      { bg: '#F0E0A0', border: '#C09030', selectedBg: '#C09030', ink: '#604010' },
  music_artists:      { bg: '#FFD0E8', border: '#D858A0', selectedBg: '#D858A0', ink: '#882060' },
  books_movies:       { bg: '#E8D8FF', border: '#9B6ED8', selectedBg: '#9B6ED8', ink: '#4A2880' },
  cars:               { bg: '#FFE8D0', border: '#E88A4D', selectedBg: '#E88A4D', ink: '#884010' },
};

...
export default function LobbyScreen() {
  ...
  const [fontsLoaded] = useFonts({ Caveat_400Regular, Caveat_700Bold, PatrickHand_400Regular, PermanentMarker_400Regular });
  ...
  const titleFont   = fontsLoaded ? 'PermanentMarker_400Regular' : undefined;
      ...
      <NotebookBackground lineStartY={0} lineSpacing={28} lineCount={50} marginX={58} showMargin={true}>
        <View style={{ paddingTop: insets.top, flex: 1 }}>
          ...
          <Animated.View entering={FadeInDown.duration(400)} style={{
            ...
            <Text style={{
              fontFamily: titleFont, fontSize: 20, color: P.inkMed,
              letterSpacing: 1,
            }}>
              Game Lobby
            </Text>
          ...
          >
            ...
            <Animated.View entering={FadeInUp.duration(500).delay(100)}>
              <View style={{
                ...
                <Text style={{ fontFamily: handFontReg, fontSize: 13, color: P.inkFaint, marginBottom: 4 }}>
                  Room Code
                </Text>
                <Text style={{
                  fontFamily: titleFont, fontSize: 42,
                  color: P.inkMed, letterSpacing: 10, marginBottom: 14,
                }}>
                  {session.code}
                </Text>
                ...
                <View style={{ flexDirection: 'row', gap: 10 }}>
                  ...
                  >
                    ...
                    <Text style={{ fontFamily: handFont, fontSize: 15, color: P.inkMed }}>Copy</Text>
                  </Pressable>
                  <Pressable
                    onPress={handleShare}
                    style={({ pressed }) => ({
                  ...
                  >
                    ...
                    <Text style={{ fontFamily: handFont, fontSize: 15, color: P.inkMed }}>Share</Text>
                  </Pressable>
                </View>
              </View>
            </Animated.View>
            ...
            <Animated.View entering={FadeInUp.duration(500).delay(200)}>
              <View style={{
                ...
                <Text style={{ fontFamily: handFont, fontSize: 16, color: P.inkMed, marginBottom: 10 }}>
                  Game Settings
                </Text>
                ...
                <View style={{ flexDirection: 'row', gap: 10, marginBottom: 12 }}>
                  <View style={{
                    ...
                    <Text style={{ fontFamily: titleFont, fontSize: 26, color: P.inkMed }}>{session.settings.totalRounds}</Text>
                    <Text style={{ fontFamily: handFontReg, fontSize: 12, color: P.inkFaint }}>Rounds</Text>
                  </View>
                  <View style={{
                    flex: 1, alignItems: 'center', paddingVertical: 10,
                    backgroundColor: P.paperDark, borderRadius: 8,
                    ...
                    <Text style={{ fontFamily: titleFont, fontSize: 26, color: P.inkMed }}>{session.settings.selectedCategories.length}</Text>
                    <Text style={{ fontFamily: handFontReg, fontSize: 12, color: P.inkFaint }}>Categories</Text>
                  </View>
                </View>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 6 }}>
                  {session.settings.selectedCategories.map((cat) => {
                    ...
                    return (
                      ...
                      >
                        {CATEGORY_ICONS[cat]}
                        <Text style={{ fontFamily: handFontReg, fontSize: 12, color: colors?.icon || P.ink }}>
                          {getCategoryName(cat)}
                        </Text>
                      </View>
                    );
              ...
              <View style={{
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                    ...
                    <Text style={{ fontFamily: handFont, fontSize: 16, color: P.inkMed }}>Players</Text>
                  </View>
                  <View style={{
                    backgroundColor: P.amberBg, paddingHorizontal: 10, paddingVertical: 3,
                    borderRadius: 20, borderWidth: 1, borderColor: P.amber,
                  }}>
                    <Text style={{ fontFamily: handFont, fontSize: 13, color: P.amber }}>
                      ...
                      >
                        <View style={{
                          ...
                          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                            ...
                            <View>
                              <Text style={{ fontFamily: handFont, fontSize: 15, color: P.inkMed }}>
                                {player.username}{isCurrentPlayer ? ' (You)' : ''}
                              </Text>
                              <Text style={{ fontFamily: handFontReg, fontSize: 11, color: player.isHost ? P.amber : P.inkFaint }}>
                ...
                {session.players.length < 10 && (
                  <View style={{
                    ...
                    borderWidth: 1, borderColor: P.paperLine + '50',
                    borderStyle: 'dashed', backgroundColor: 'transparent',
                  }}>
                    <Text style={{ fontFamily: handFontReg, fontSize: 12, color: P.inkFaint, textAlign: 'center', fontStyle: 'italic' }}>
          ...
          {isHost ? (
            ...
            >
              ...
              >
                <View style={{
                  ...
                  <Text style={{
                    fontFamily: handFont, fontSize: 20,
            ...
            >
              <View style={{
                ...
                <Text style={{ fontFamily: handFontReg, fontSize: 14, color: P.inkFaint, textAlign: 'center', fontStyle: 'italic' }}>

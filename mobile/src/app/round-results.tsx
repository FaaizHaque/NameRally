      ...
      <View style={{ paddingTop: insets.top, flex: 1 }}>
          ...
          >
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              ...
              <View>
                <Text style={{ color: SKETCH_COLORS.ink, fontSize: 22, fontWeight: '900' }}>
                  {phase === 'answers' ? 'Results' : 'Standings'}
                </Text>
                {phase === 'answers' && (
            ...
            {phase === 'answers' ? (
              ...
              <Animated.View entering={FadeIn.duration(500)}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 20 }}>
                  <Trophy size={24} color={SKETCH_COLORS.amber} strokeWidth={2.5} />
                  <Text style={{ color: SKETCH_COLORS.ink, fontSize: 20, fontWeight: '900' }}>Current Standings</Text>
                </View>

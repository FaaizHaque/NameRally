                ...
                <View style={{
                  ...
                  <View className="items-center">
                    <View className="flex-row items-center gap-1">
                      ...
                      <Text style={{ color: '#E8FFE8', fontWeight: '800', fontSize: 16 }}>{correctCount}/5</Text>
                    </View>
      ...
      <LinearGradient colors={['#0D1F0D', '#1C3A1C', '#0D2A0D']} style={{ flex: 1 }} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1" keyboardVerticalOffset={0}>
          <View style={{ paddingTop: insets.top }} className="flex-1">
            ...
            {/* Categories Input */}
            <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 140 }} keyboardShouldPersistTaps="handled">
            ...
            {/* Submit Button */}
            <Animated.View entering={FadeInUp.duration(500).delay(400)} style={{ position: 'absolute', bottom: 0, left: 0, right: 0, paddingHorizontal: 16, paddingBottom: insets.bottom + 16 }}>
